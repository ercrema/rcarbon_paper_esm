...
## Calibrate Dates
southlevant.x <- calibrate(southLevant$CRA,southLevant$Error,normalised=F,verbose=F,calCurves='shcal20')
sahara.x <- calibrate(sahara$Yrs.BP,sahara$STD,normalised=F,verbose=F,calCurves='intcal20')
brazil.x <- calibrate(brazil$CRA,brazil$Error,normalised=F,verbose=F,calCurves='intcal20')
