...
All analyses and figures require the installation of the _rcarbon_ package version 1.4.0 and additional data supplied in the ESM. To install _rcarbon_ type the following command in the R console:
...
ew.mod <- modelTest(x.ew,errors=ewdates$C14SD,bins=bins.ew,timeRange=c(8000,4000),nsim=1000,runm=50,ncores=ncores,backsight=100,verbose=FALSE)
