...
All analyses and figures require the installation of the _rcarbon_ package version 1.4 and additional data supplied in the ESM. To install _rcarbon_ type the following command in the R console:
